...
const EditServices = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:5000/api/getoneservices/${id}`)
      .then((response) => {
  ...
  const submitForm = async (e) => {
    ...
    await axios
      .put(`http://localhost:5000/api/updateservice/${id}`, formData, {
        headers: {
  ...
  return (
    <div className="editProduct">
      ...
      <h3 style={{ color: "black", marginRight: "20px", marginRight: "50px" }}>Update Services</h3>
